...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("House_rental.DBHelper, House_rental", DBHelper.class, __md_methods);
	}
	...
	public DBHelper (android.content.Context p0, java.lang.String p1, android.database.sqlite.SQLiteDatabase.CursorFactory p2, int p3)
	{
		...
		if (getClass () == DBHelper.class)
			mono.android.TypeManager.Activate ("House_rental.DBHelper, House_rental", "Android.Content.Context, Mono.Android:System.String, mscorlib:Android.Database.Sqlite.SQLiteDatabase+ICursorFactory, Mono.Android:System.Int32, mscorlib", this, new java.lang.Object[] { p0, p1, p2, p3 });
	}
	...
	public DBHelper (android.content.Context p0, java.lang.String p1, int p2, android.database.sqlite.SQLiteDatabase.OpenParams p3)
	{
		super (p0, p1, p2, p3);
		if (getClass () == DBHelper.class)
			mono.android.TypeManager.Activate ("House_rental.DBHelper, House_rental", "Android.Content.Context, Mono.Android:System.String, mscorlib:System.Int32, mscorlib:Android.Database.Sqlite.SQLiteDatabase+OpenParams, Mono.Android", this, new java.lang.Object[] { p0, p1, p2, p3 });
	}
